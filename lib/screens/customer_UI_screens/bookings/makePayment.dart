...
//   void getUid() async {
//     final String userId = await _localStorageService.getter('uid');
//     print('uid is: $userId');
...
//     try {
//       final response = await Networking.post('bookings/add-booking', {
...
//   void _handlePaymentSuccess(PaymentSuccessResponse response) async {
//     try {
//       final response = await Networking.post('events/make-event-premium', {
